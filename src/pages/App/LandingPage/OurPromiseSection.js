              ...
              <Box
                ...
                <ShowMore withTxt={false} numberOfLines={4}>
                  <span>
                    ...
                    <br /> Our board of subject matter experts are equipped with
                    all the tools to monitor and objectively assess the quality
            ...
            <Box textAlign='left' className={classes.specialityFieldPadding}>
              ...
              <Box
                ...
                <ShowMore withTxt={false} numberOfLines={4}>
                  ...
                  we believe your needs would vary in nature <br />
                  and size. An urgent question would popup any moment which
                  needs and quick reliable answer from an expert, or a second
                  opinion is needed to make sure you are in the right track in
                  your new product and a call with a subject matter expert will
                  give you a fresh perspective. What if you have a very
                  specialized assignment which requires a top expert in an area
                  beyond your teams’ expertise, and a subject matter exert is
                  needed to work on it with your team. Your needs are
                  diversified and so our solutions, from advisory bites to full
                  consultancy feast we are here to support with the same high
                  quality and same focus.
                </ShowMore>
              </Box>
            </Box>
          </Grid>
