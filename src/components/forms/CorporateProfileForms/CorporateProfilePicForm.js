...
import CorporateProfilePictureDialog from '../CorporateProfilePictureDialog';

const CorporateProfilePicForm = ({ user, closeDialog, setProfilePic }) => {
...
export default CorporateProfilePicForm;
