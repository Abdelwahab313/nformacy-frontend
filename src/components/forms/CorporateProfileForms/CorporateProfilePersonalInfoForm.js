...
import CorporatePersonalInfoDialog from '../CorporatePersonalInfoDialog';

const CorporateProfilePersonalInfoForm = ({ user, closeDialog }) => {
...
export default CorporateProfilePersonalInfoForm;
